...
<%
List acincomingList = (List)request.getAttribute("acincomingList");
%>
<body>
<!-- UI Object -->	
<div id="wrap">
...
<% 
for(int i=0;i<acincomingList.size();i++){
	AccountingBean acBean = (AccountingBean)acincomingList.get(i);%>
<tr>
	<td>
