	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="content">
				...
				<form action="./SeqModifyAction.sq" method="post">
				<input type="hidden" name="num" value="<%=seq.getSeq_num()%>">
		...
		<tr>
			...
			<td>
				<div class="item">
					<input type="text" name="seq_title" id="temp_input"class="i_text" style="width: 300px" value="<%=seq.getSeq_title()%>">
		</div>
						</td>
					</tr>
	<tr>
			...
			<td>
				<div class="item">
					<textarea name="seq_content" cols="100" rows="10" title="레이블 텍스트"
						id= "contents" class="i_text" style="display: none;"><%=seq.getSeq_content() %></textarea>
				</div>
			</td>
		</tr>
