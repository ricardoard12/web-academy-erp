...
<body>
	...
	<div id="menu" class="menu mc_gray">
		...
		<div class="" align="center"
			style="height: 50px; width: 200px; margin-bottom: 12px; margin-left: 15px;">
			<a href="./"><img src="./img/academy.gif"
				style="height: 50px; width: 200px;"></a>
			<!-- Horizonal navigation -->
					...
					<div class="major">
						...
						<ul>
							...
							<li class="m3"><a href="#"><span>입시정보</span></a>
								<div class="sub">
									<ul>
										<li><a href="#"><span>입시뉴스</span></a></li>
										<li><a href="#"><span>입시자료</span></a></li>
										<li><a href="#"><span>대입 FAQ</span></a></li>
										<li><a href="#"><span>수시/입학사정관제</span></a></li>
										<li><a href="#"><span>입시 투데이</span></a></li>
										<li><a href="#"><span>논술/면접/적성검사</span></a></li>
										<li><a href="#"><span>비교과정보</span></a></li>
									</ul>
								</div></li>
							<li class="m4"><a href="#"><span>학습/진로</span></a>
								<div class="sub">
									<ul>
										<li><a href="#"><span>진학/인성</span></a></li>
										<li><a href="#"><span>학습뉴스/정보</span></a></li>
										<li><a href="#"><span>추천도서</span></a></li>
										<li><a href="#"><span>유학정보</span></a></li>
										<li><a href="#"><span>진로/직업자료실</span></a></li>
										<li><a href="#"><span>학습자료실</span></a></li>
										<li><a href="#"><span>취업뉴스/정보</span></a></li>
									</ul>
								</div></li>
							<li class="m5"><a href="#"><span>커뮤니티</span> <!-- <span class="i"></span> --></a>
								<div class="sub">
									<ul>
										...
										<li><a
											href="./Faq_boardList.fb?name=<%=name%>&id=<%=id%>"><span>FAQ</span></a></li>
									</ul>
								</div></li>
			...
			<script type="text/javascript">
				jQuery(function($) {
					...
					li_list.find('>a').click(onselectmenu).mouseover(show_menu)
							.focus(show_menu);
