	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="content">
				<!-- banner -->
				<div class="banner">
					<img src="./img/banner.jpeg" width="700px">
				</div>
				<!-- banner -->
				<!-- board list -->
					...
					<div class="row">
						<ul>
							<li class="col">
								...
								<ul>
									...
									%>
									<li><a
										href="./BoardDetailAction.bo?num=<%=noti.get(0)%>&gid=<%=noti.get(8)%>"><%=noti.get(3)%></a></li>
									<%
										}
										}
									%>
							...
							<li class="col">
								<h5>
									<a href="./BoardNotice.bo?gid=21">입시자료</a>
								</h5>
								<ul>
									<%
										if (libIb.size() < 1) {
									...
									%>
									<li><a
										href="./BoardDetailAction.bo?num=<%=lib.get(0)%>&gid=<%=lib.get(8)%>"><%=lib.get(3)%></a></li>
									<%
										}
										}
									%>
						...
						<div class="row">
							<ul>
								<li class="col">
									<h5>
										<a href="./BoardNotice.bo?gid=13">수업자료</a>
									</h5>
									<ul>
										<%
											if (libSu.size() < 1) {
								...
								<li class="col">
									<h5>
										<a href="./BoardNotice.bo?gid=20">입시뉴스</a>
									</h5>
									<ul>
										<%
											if (newIb.size() < 1) {
