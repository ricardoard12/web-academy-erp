		...
		<ul>
			...
			<li><a><span>게시판</span><span class="i"></span></a> <!-- Level에 따른 열람 제한 설정 -->
				...
				<ul style="display: none;">
					...
					<!-- 강의계획서는 12 -->
					<li><a href="./BoardNotice.bl?gid=11"><span>강의계획서</span></a></li>
					<!-- 수업자료실 13 -->
					<li><a href="./BoardNotice.bl?gid=11"><span>수업자료실</span></a></li>
					<!-- 직원 자료실은 14 -->
					<li><a href="./BoardNotice.bl?gid=11"><span>직원자료실</span></a></li>
					<!-- 직원 계시판은 15 -->
					<li><a href="./BoardNotice.bl?gid=11"><span>직원게시판</span></a></li>
				</ul></li>
			<%
				}
			%>
