	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="content">
				...
				<!-- 직원 출근 현황 시작 -->
				<!-- 학급명 -->
				<form action="./StudentAttitudeList.st" method="post">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								onclick="location.href='./StudentAttitudeTimeRecordingAction.st?type=come&id=<%=attitude.getAt_member_id()%>'">
								<%
									}
								%>
							</td>
							<td>
								...
								onclick="location.href='./StudentAttitudeTimeRecordingAction.st?type=leave&id=<%=attitude.getAt_member_id()%>'">
								<%
									}
								%>
							</td>
