	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="content">
				...
				<form action="./LessonModifyAction.le" method="post">
					<fieldset>
						<legend><b>강의계획서 입력 FORM</b></legend>
						<div class="form_table">
							<table border="1" cellspacing="0" summary="회원가입">
							<input type="hidden" name="lesson_num" value="<%=Integer.parseInt(request.getParameter("num"))%>">
								...
								<tbody>
										...
										<td>
											<div class="item">
												<input type="text" name="lesson_subject" id="temp_input"
													class="i_text" style="width: 300px" value="<%=lessonbean.getLesson_subject() %>">
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<input type="text" name="lesson_book" id="temp_input"
													class="i_text" style="width: 300px" value="<%=lessonbean.getLesson_book() %>">
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="item">
												<input type="text" name="lesson_cost" id="temp_input"
													class="i_text" style="width: 300px" value="<%=lessonbean.getLesson_cost() %>">
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="item">
												<input type="text" name="lesson_time" id="temp_input"
													class="i_text" style="width: 300px" value="<%=lessonbean.getLesson_time() %>">
											</div>
										</td>
									</tr>
									<tr>
...
<!-- 											</div> -->
												<textarea rows="10" cols="150" name="lesson_goal"><%=lessonbean.getLesson_goal() %>
												</textarea>
										</td>
									</tr>
...
<!-- 													style="display: none;"></textarea> -->
<!-- 											</div> -->
												<textarea rows="10" cols="150" name="lesson_content">
												<%=lessonbean.getLesson_content() %></textarea>
										</td>
									</tr>
